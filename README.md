...
El proyecto fue creado como solución a un desafío práctico de la academia **[CADIF1](https://cadif1.com/)** 🎓, poniendo a prueba el uso de **Sass (SCSS)** avanzado y la implementación de una arquitectura modular mediante archivos parciales. 🎨🔥

---

## 🌐 Live Demo

👉 **[Haz clic aquí para ver la web](https://sebaxlandaeta.github.io/replica-toplevelstore/)**
...
5. 🚨 **Control de Errores en Consola (`@error`):** Si la variable global `$anchoBoton` es menor a `20px` (haciendo que el cálculo `$ancho * 5` sea inferior a `100px`), Sass interrumpe la compilación emitiendo el mensaje de error: `"El valor del ancho debe ser mayor a 20"`.
